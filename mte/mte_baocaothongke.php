       ...
       # message after add or edit
		...
		$seach_form .= "
				...
				<td style='padding: 15px; width: $this->width_editor'>
					...
					<td style='padding: 15px;'><input  style='width:60px;color:red;border: 1px solid #000;height:20px' type=\"submit\" value='BCKT' onClick=\"window.location.href='./baocaothang01.php?from=$ngayfrom&to=$ngayto&s=$s&f=$f'\" /></td>
					<td style='padding: 15px;'><input  style='width:60px;color:red;border: 1px solid #000;height:20px' type=\"submit\" value='BCSX' onClick=\"window.location.href='./baocaothang02.php?from=$ngayfrom&to=$ngayto&s=$s&f=$f'\" /></td>
					<td style='padding: 15px;'><input  style='width:60px;color:red;border: 1px solid #000;height:20px' type=\"submit\" value='Mẫu cũ' onClick=\"window.location.href='./baocao_giolamviec.php'\" /></td>
			</tr>
			</table>
			</div>
			";
