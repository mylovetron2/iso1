...
while($row = mysql_fetch_array($result))
{
	...
	// Đếm số máy đạt (bao gồm cả NULL), hỏng, TTKTĐB, chờ vật tư, đang sửa chữa
	if ($ttktafter=="Đạt" || $ttktafter=="" || $ttktafter==NULL) $tongmaydat++;
...
$tongmay=$tongmay +$i-1;
    ...
    echo "<tr>
          <td height=\"25\" colspan=\"10\">&nbsp;<b> Tổng số máy đạt : $tongmaydat</b></td>
	  </tr>";
    echo "<tr>
          <td height=\"25\" colspan=\"10\">&nbsp;<b> Tổng số máy hỏng (Không khắc phục được) : $tongmayhong</b></td>
	  </tr>";
    echo "<tr>
          <td height=\"25\" colspan=\"10\">&nbsp;<b> Tổng số máy TTKTĐB : $tongmayttktdb</b></td>
	  </tr>";
    echo "<tr>
          <td height=\"25\" colspan=\"10\">&nbsp;<b> Tổng số máy chờ vật tư thay thế : $tongmayvattu</b></td>
	  </tr>";
    echo "<tr>
          <td height=\"25\" colspan=\"10\">&nbsp;<b> Tổng số máy đang sửa chữa : $tongmaydangsc</b></td>
	  </tr>";
