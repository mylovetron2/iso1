...
// Xử lý xuất Excel
if(isset($_GET['xuatexcel']) && $_GET['xuatexcel']==1 && $baocao=="kehoach"){
    $year = isset($_GET['year']) ? $_GET['year'] : date("Y");
    ob_start();
    include("xuatexcel_kehoach_hckd.php");
    exit;
}
?><head>
...
<td><input type="button" value="Xuất Excel" style="width:120px;height:30px;border:1px solid #000;background:#4CAF50;color:white;cursor:pointer;" onClick="window.location.href='baocaohckd.php?baocao=kehoach&year=<?php echo $year; ?>&xuatexcel=1'" /></td>
</tr>
</table>
<?php 
